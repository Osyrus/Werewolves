...
// previousNominations: This is an array that contains all the players this player has nominated this cycle
...
// These are settings that are used to affect things, like rules and such.
// Players can change these in a settings menu.
GameSettings = new Mongo.Collection("gameSettings");

// This will contain a history of all the previous games
